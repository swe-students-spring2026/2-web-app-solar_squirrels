...
Copy the contents of the provided .env file into the "main" folder within the repository. From the repository root, run `pipenv shell`, then `pipenv run python main/run.py`. Navigate to http://127.0.0.1:5001/ in the browser. You may then create an account, or use the provisional credentials (user: test password: test) to log in and begin using the app.
